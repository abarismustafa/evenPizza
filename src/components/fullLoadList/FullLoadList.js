                    ...
                    <div className="card-body p-0">
                        <div className="table-responsive active-projects style-1">
                            <div className="tbl-caption">
                                ...
                                <div>
                                    <Link className="btn btn-primary btn-sm" to="/fullLoad/add" role="button" aria-controls="offcanvasExample">+ Add New</Link>
                                </div>
                            </div>
                                ...
                                <table id="empoloyees-tblwrapper" className="table dataTable no-footer" role="grid" aria-describedby="empoloyees-tblwrapper_info">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th style={{ width: '150px' }}>Consiqnor</th>
                                            <th style={{ width: '150px' }}>Consiqnee</th>
                                            <th style={{ width: '150px' }}>Weight</th>
                                            <th style={{ width: '150px' }}>Party Rate</th>
                                            <th style={{ width: '150px' }}>Party Freight</th>
                                            <th style={{ width: '150px' }}>Trans Rate</th>
                                            <th style={{ width: '150px' }}>Trans Freight</th>
