...
import { getTravelAllState, getAllAccountData, getAllSalesmanData, getPickupByPage, getProductList, getTravelAllCity, getTravelAllCountry, } from '../../api/login/Login';
  ...
  return (
    <div className='card' style={{ marginTop: "10px", marginLeft: "4px", marginRight: "4px" }}>
      <form className='row'>
        ...
        <div className="col-4 mt-2">
          <label for="exampleFormControlInput1" className="form-label mb-0">Order Status</label>
          <select className='form-select form-control'>
        ...
        <div className="col-4 mt-2">
          <label for="exampleFormControlInput1" className="form-label mb-0">Order Type</label>
          <select className='form-select form-control'>
        ...
        <div className="col-4 mt-2">
          <label for="exampleFormControlInput1" className="form-label mb-0">PO No</label>
          <input type="text" className="form-control" placeholder='Enter PO No' name='po_no' value={formData?.po_no} onChange={handleInputChange} id="exampleFormControlInput1" />
        </div>
