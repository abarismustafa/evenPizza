...
import { getHotelVoucher } from '../../../api/login/Login';
...
function HotelVoucher() {
    ...
    return (
        <>
            ...
            <HotelVoucherFilter filterInitial={filterInitial} handleChange={handleChange} getTransitionReport={getTransitionReport} />
            <HotelVoucherList page={page} count={count} onChangeVal={onChangeVal} data={data} totalCount={totalCount} />
        </>
    )
}
