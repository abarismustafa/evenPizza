...
const LeadWiseFilter = ({ filterInitial, handleChange, getTransitionReport }) => {
                ...
                <div className="card-body p-0">
                    <div className="table-responsive active-projects style-1">
                        <div className="tbl-caption tbl-caption-2">
                            <h4 className="heading mb-0 p-2">Filter Lead Report</h4>
                        </div>
                        <form className="tbl-captionn">
                            <div className="row">
                                ...
                                <div className="col-lg-12 mt-2" style={{ textAlign: 'center' }}>
                                    <button type="button" className="btn btn-primary" style={{ width: '300px', textAlign: 'center' }} onClick={() => getTransitionReport(0)}>Search</button>
                                </div>
                            </div>
                        </form>
                    </div>
