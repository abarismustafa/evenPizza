...
const PurchaseQuatation = () => {
    const breadCrumbsTitle = {
        ...
        title_1: "Transaction",
        title_2: 'Quatation',
        title_3: `List Of PurchaseQuatation`,
        path_2: ``
    };
                        ...
                        <div className="table-responsive active-projects style-1">
                            <div className="tbl-caption">
                                <h4 className="heading mb-0">
                                    List Of Purchase Quatations
                                </h4>
                                <div>
                                    <Link className="btn btn-primary btn-sm" to="/purchasequotation/add" role="button" aria-controls="offcanvasExample">+ Add New</Link>
                                </div>
                            </div>
                                            ...
                                            return <tr role="row" className="odd" >
                                                ...
                                                <td>
                                                    ...
                                                    <div className="d-flex">
                                                        <Link to={`/purchasequotation/edit/${item?._id}`} className="btn btn-primary shadow btn-xs sharp me-1">
...
export default PurchaseQuatation
