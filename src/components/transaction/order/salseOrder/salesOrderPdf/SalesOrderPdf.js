            ...
            <Page size="A4" style={styles.page}>
                <View style={styles.container}>
                    ...
                    <View style={styles.flexb}>
                        ...
                        <View >
                            <Text>Order No: <Text style={styles.boldText}>{data.quoteDetails.OrderNo}</Text></Text>
                            <Text>Order Date: <Text style={styles.boldText}>{data.quoteDetails.OrderDate}</Text></Text>
                        </View>
                    </View>
