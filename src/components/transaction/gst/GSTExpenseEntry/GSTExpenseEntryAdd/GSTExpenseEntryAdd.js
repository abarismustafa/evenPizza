                        ...
                        <div className="card-body p-0">
                            <div className="table-responsive active-projects style-1">
                                <div className="tbl-caption tbl-caption-2">
                                    <h4 className="heading mb-0 p-2">Add GST Expense Entry</h4>
                                </div>
                                <div className="row">
                                <div className="col-md-3 mb-3">
                                    ...
                                    <div className="col-md-3 mb-3">
                                        <label htmlFor="taxType">Doc Type </label>
                                        <select
                                            className="form-control"
                                            name="taxType"
                                    ...
                                    <div className="col-md-3 mb-3">
                                        <label htmlFor="voucherAmount">Doc Amount : </label>
                                        <input
                                            type="number"
                                            className="form-control"
                                            name="voucherAmount"
...
export default GSTExpenseEntryAdd