...
// function DNEntrywithStockAdd() {
//     const breadCrumbsTitle = {
//         id: "1",
//         title_1: "Transaction",
//         title_2: 'GST',
//         title_3: `Add DN Entry with Stock`,
//         path_2: ``
//     };
...
//                                     <h4 className="heading mb-0">Add DN Entry with Stock</h4>
//                                 </div>
//                                 <div className="row">
...
//     )
// }
// export default DNEntrywithStockAdd
                ...
                <div className="col-xl-12">
                    <div className="card">
                        <div className="card-body p-0">
                            <div className="table-responsive active-projects style-1">
                                <div className="tbl-caption tbl-caption-2">
                                    <h4 className="heading mb-0 p-2">Add DN Entry with Stock</h4>
                                </div>
                                <div className="row">
                                    ...
                                    <div className="col-md-3 mb-3">
                                        ...
                                        >
                                            ...
                                            <option value="dredit">Credit</option>
