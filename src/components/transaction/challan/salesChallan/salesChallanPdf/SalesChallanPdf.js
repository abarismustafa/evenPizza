                ...
                <View style={styles.container}>
                    ...
                    <View style={styles.flexb}>
                        ...
                        <View >
                            ...
                            <Text>Date: <Text style={styles.boldText}>{data.quoteDetails.challanDate}</Text></Text>
                            <Text>Transport: <Text style={styles.boldText}>{data.quoteDetails.transport}</Text></Text>
                            <Text>Lr No: <Text style={styles.boldText}>{data.quoteDetails.lrNo}</Text></Text>
                        </View>
                    </View>
...
export default SalesChallanPdfs;