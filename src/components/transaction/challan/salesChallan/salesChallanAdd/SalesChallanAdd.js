...
import { getAccAddProjectByPage, getAllAccountData, getAllProductsData, getAllRatesheetData, getAllTaxTypeData, getAllTransportersData, getAttTaxTypeData, getPickupByPage, getSalesChallanById, getTaxtype, postquotationMaster, postSalesChallan, updateSalesChallan } from "../../../../../api/login/Login";
...
const SalesChallanAdd = () => {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Transaction",
        title_2: 'Order',
        title_3: `Add Sales Challan`,
        path_2: ``
    };
    ...
    const getByIdData = async () => {
        try {
            const res = await getSalesChallanById(params?.id);
    ...
    const handleSubmitData = async () => {
        ...
        if (params?.id) {
            ...
            try {
                const res = await updateSalesChallan(payload)
                        ...
                        <div className="card-body p-0">
                            <div className="table-responsive active-projects style-1">
                                <div className="tbl-caption tbl-caption-2">
                                    <h4 className="heading mb-0 p-2">{params?.id ? "Update" : "Add"} Sales Challan</h4>
                                </div>
                                <div className="row">
...
export default SalesChallanAdd