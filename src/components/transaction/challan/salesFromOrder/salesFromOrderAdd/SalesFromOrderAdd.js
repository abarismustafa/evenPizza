...
import { getAccAddProjectByPage, getAllAccountData, getAllLocationsData, getAllPickupPointsData, getAllProductsData, getAllRatesheetData, getAllTaxTypeData, getAllTransportersData, getAttTaxTypeData, getbyIdPurchase, getPickupByPage, getSaleFromOrderById, getTaxtype, postPurchase, postSaleFromOrder, updatePurchase, updateSaleFromOrder } from "../../../../../api/login/Login";
...
const SalesFromOrderAdd = () => {
    ...
    const getEditData = async () => {
        try {
            const res = await getSaleFromOrderById(parem.id)
            console.log(res);
            setFormData({
                date: res.data?.date,
    ...
    const handleSubmitData = async () => {
        ...
        try {
            const res = await postSaleFromOrder(obj)
    ...
    const handleUpdateData = async () => {
        ...
        try {
            const res = await updateSaleFromOrder(obj, parem.id)
            if (res?.statusCode == '200') {
                setLoad(false)
                        ...
                        <div className="card-body p-0">
                            <div className="table-responsive active-projects style-1">
                                <div className="tbl-caption tbl-caption-2">
                                    <h4 className="heading mb-0 p-2">Add Sales From Order</h4>
                                </div>
                                <div className="row">
