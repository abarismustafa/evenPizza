...
import { getAccAddProjectByPage, getAllAccountData, getAllLocationsData, getAllPickupPointsData, getAllProductsData, getAllRatesheetData, getAllTaxTypeData, getAllTransportersData, getAttTaxTypeData, getbyIdPurchase, getbyIdPurchaseChallan, getPickupByPage, getTaxtype, postPurchase, postPurchaseChallans, updatePurchase, updatePurchaseChallans } from "../../../../api/login/Login";
import { toast, ToastContainer } from "react-toastify";
import Loadar from "../../../../common/loader/Loader";
import { useParams } from "react-router-dom";

const PurchangefromChalanAdd = () => {
    const breadCrumbsTitle = {
        id: "1",
        title_1: "Transaction",
        title_2: 'Challan',
        title_3: `Add Purchase From Order`,
        path_2: ``
    };
    ...
    const getEditData = async () => {
        try {
            const res = await getbyIdPurchaseChallan(parem.id)
            console.log(res);
            setFormData({
                ...res.data
            })
    ...
    const handleSubmitData = async () => {
        ...
        try {
            const res = await postPurchaseChallans(obj)
    ...
    const handleUpdateData = async () => {
        ...
        try {
            const res = await updatePurchaseChallans(obj, parem.id)
            if (res?.statusCode == '200') {
                setLoad(false)
                        ...
                        <div className="card-body p-0">
                            <div className="table-responsive active-projects style-1">
                                <div className="tbl-caption tbl-caption-2">
                                    <h4 className="heading mb-0 p-2">Add Purchase From Order</h4>
                                </div>
                                {/* <div className="row">
                                    ...
                                    <div className="col-md-3 mb-3">
                                        <label htmlFor="account">SP Account</label>
                                        <select
                                            className="form-control"
                                            name="sp_account"
                                            ...
                                            onChange={handleInputChange}
                                        >
                                            <option value="">Select SP Account</option>
                                            {allAccounts && allAccounts?.map((item, i) => {
                                                return <option value={item?._id}>{item?.name}</option>
                                            })}
                                        </select>
...
export default PurchangefromChalanAdd