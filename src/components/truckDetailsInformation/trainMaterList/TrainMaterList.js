...
import TrainMasterTable from './TrainMasterTable';
import TrainMasterForm from './TrainMasterForm';

const TrainMaterList = () => {
       ...
       {!isActive ? (
         <>
           <div className="bg-black text-light p-2 d-flex justify-content-between align-items-center m-2">
             <h2 className="fs-4">List Of Train Master</h2>
             <div></div>
           </div>
           ...
           <div className="card m-2">
             ...
             <TrainMasterTable thead={thead} tbody={tbody} />
           </div>
         </>
       ) : (
         <div className="">
           <div className="bg-black text-light p-2 d-flex justify-content-between align-items-center m-2">
             <h2 className="fs-4">
               {selectedAction.icon} {selectedAction.name} Train Master
             </h2>
             <button
