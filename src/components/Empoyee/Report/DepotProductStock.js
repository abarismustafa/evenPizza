...
export default function DepotProductStock(){
    return(
        <div>
            ...
            <div className="card">
                <div className="table-responsive active-projects style-1">
                    <div className="tbl-caption">
                        <h4 className="heading mb-0">Depot Product Stock</h4>
                        <div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-md-6 col-12">
                            <div className="mt-2">
                                ...
                                <div className="w-100">
                                    <input type="search" className="form-control" placeholder="Search Depot" />
                                </div>
                            </div>
                        </div>
                        <div className="col-md-6 col-lg-3 col-12">
