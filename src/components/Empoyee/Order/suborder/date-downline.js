...
import { getAllAccountData, getAllPickupPointsData, getAllSalesmanData, getPickupByPage, getTravelAllCity, getTravelAllCountry, getTravelAllState } from '../../../../api/login/Login';
  ...
  return (
    <div className='card' style={{ marginTop: "10px", marginLeft: "4px", marginRight: "4px" }}>
      <form className='row'>
        ...
        {/* <div className="col-4 mt-2">
          <label for="exampleFormControlInput1" className="form-label mb-0">Customer</label>
