...
import { getAllAccountData, getAllSalesmanData, getPickupByPage, getTravelAllCity, getTravelAllCountry, getTravelAllState } from '../../../../api/login/Login';
import Multiselect from 'multiselect-react-dropdown';

function DateToCustom() {
  ...
  return (
    ...
    <div className='card' style={{ marginTop: "10px", marginLeft: "4px", marginRight: "4px" }}>
      <form className='row'>
        ...
        <div className="col-4 mt-2">
          <label for="exampleFormControlInput1" className="form-label mb-0">Custom</label>
          <select className='form-select form-control'>
