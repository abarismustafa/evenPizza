...
function EtgTimesheetDashboardComp() {
    const data = [
        {
            name: 'New',
            uv: 33,
                ...
                <div className="dashboard-gaot">
                    ...
                    <div className="row mt-3">
                        <div className="card-dash flight ms-2 me-2">
                            <span className="number">Billable Hours</span>
                        ...
                        <div className="card-dash flight ms-2 me-2">
                            <span className="number">Non Billable Hours</span>
                            <span className="label">670</span>
                            <span className="number"><IoMdArrowUp style={{ marginBottom: '4px' }} />12 <PiPercentDuotone /> Since Last Period</span>
                        </div>
                        <div className="card-dash flight ms-2 me-2">
                            <span className="number">Billable Rates</span>
                        ...
                        <div className='col-lg-6 col-md-6 col-sm-12'>
                            <div className="bookings">
                                ...
                                <table>
                                    <thead>
                                        <tr>
                                            <th className='text-centre'>Projects</th>
                                            <th className='text-centre'>Hours Spent</th>
                                            <th className='text-centre'>Hours Billed</th>
                                            <th className='text-centre'>Billed Rate</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
...
export default EtgTimesheetDashboardComp