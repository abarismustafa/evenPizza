                ...
                <div className="dashboard-gaot">
                    ...
                    <div className="row mt-3">
                        <div className="card-dash flight ms-2 me-2">
                            <span className="number">Tickets</span>
                        ...
                        <div className="card-dash flight ms-2 me-2">
                            <span className="number">Time to Respond</span>
                            <span className="label">20 Days</span>
                            <span className="number"><IoMdArrowUp style={{ marginBottom: '4px' }} />12 <PiPercentDuotone /> Since Last Period</span>
                        </div>
                        <div className="card-dash flight ms-2 me-2 mt-2">
                            <span className="number">Time to Close</span>
                            <span className="label">20 Days</span>
                            <span className="number"><IoMdArrowUp style={{ marginBottom: '4px' }} />12 <PiPercentDuotone /> Since Last Period</span>
                        </div>
                    </div>
                        ...
                        <div className='col-lg-6 col-md-6 col-sm-12'>
                            <div className="bookings">
                                ...
                                <table>
                                    <thead>
                                        <tr>
                                            <th className='text-centre'>Agent</th>
                                            <th className='text-centre'>Tickets</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                        ...
                        <div className='col-lg-6 col-md-6 col-sm-12'>
                            <div className="bookings">
                                ...
                                <table>
                                    <thead>
                                        <tr>
                                            <th className='text-centre'>Team</th>
                                            <th className='text-centre'>Tickets</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                        ...
                        <div className='col-lg-6 col-md-6 col-sm-12'>
                            <div className="bookings">
                                ...
                                <table>
                                    <thead>
                                        <tr>
                                            <th className='text-centre'>Ticket Type</th>
                                            <th className='text-centre'>Ticket</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
...
export default EtgHelpDeskDashComp