...
const PartyDealerDetail = () => {
    return (
        <div className="card">
          <h2 className="bg-black text-light p-2 fs-4">Party/Dealer List</h2>
              ...
              <table className="table table-bordered table-striped table-responsive">
                <thead className="table-dark ">
                  <tr className="text-light">
                    ...
                    Existing Customer(Party) Short Report
                    </th>
                  </tr>
                </thead>
                <tbody>
...
export default PartyDealerDetail