...
import TruckOwnerTable from './TruckOwnerTable';
       ...
       {!isActive ? (
         <>
           <div className="bg-black text-light p-2 d-flex justify-content-between align-items-center m-2">
             <h2 className="fs-4">List Of Truck Owner</h2>
             <div></div>
           </div>
           ...
           <div className="card m-2">
             ...
             <TruckOwnerTable thead={thead} tbody={tbody} />
           </div>
         </>
       ) : (
         <div className="">
           <div className="bg-black text-light p-2 d-flex justify-content-between align-items-center m-2">
             <h2 className="fs-4">
               {selectedAction.icon} {selectedAction.name} Truck Owner
             </h2>
             <button
